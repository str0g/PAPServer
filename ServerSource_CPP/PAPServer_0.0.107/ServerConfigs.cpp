...
int ServerConfigs::intSizeOfFormatter = 0;
int ServerConfigs::intStdIn = 0;
int ServerConfigs::intServerPort = 0;
int ServerConfigs::intClientTimeOut = 0;
...
void ServerConfigs::SetVaruables(){
    ...
    intSizeOfFormatter = X->GetNumericValue<int>("SizeOfFormatter","80");
    ///Server
    ...
    intClientTimeOut = X->GetNumericValue<int>("ClientTimeOut","60");

    ///Setting up static values
    Set_strTimeFormatter(strFormatter);
    Set_intFormatterLenght(intSizeOfFormatter);
...
void ServerConfigs::ShowConfigs(){
    ...
    cout<<"SizeOfFormatter: "<<intSizeOfFormatter<<endl;
    cout<<"True Lenght of buffor: "<<GetLocalTime().length()<<endl;
    ...
    cout<<"Client Time out:"<<intClientTimeOut<<endl;
